...
files_to_compile = ['syn6288_test', 'libSYN6288/Syn6288']
directories = ['libSYN6288']
file_to_compile = 'syn6288_test'
if len(sys.argv) == 2:
    com_port = 'com4'
else:
	com_port = sys.argv[2]
...
if level_of_compilation >= 1: 
    for fs in files_to_compile:
        cmd = 'avr-gcc.exe -Wall -Os -DF_CPU=16000000UL -mmcu=atmega328p -c -o'+fs+'.o '+fs+'.c'
        run_command(cmd)
